...
class BradescoAccessToken
{
    ...
    private static $urlProduction       = 'https://proxy.api.prebanco.com.br/auth/server/v1.1/token';
    ...
    public static function setCertPath(string $path = null)
    {
        ...
        if (static::$certPath === false) {
            // print_r("Missing required parameter 'CERT_PATH'");
    ...
    public static function setCertPassword(string $password = null)
    {
        ...
        if (static::$certPassword === false) {
            // print_r("Missing required parameter 'CERT_PASSWORD'");
